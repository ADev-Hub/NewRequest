...
import {} from "@pnp/logging/";
// import {ILogEntry} from "@pnp/logging/src/logging";
...
export class LogItem implements ILogItem {
    constructor(
        public ApplicationName: string = "Request Form",
...
export default class CustomLogger implements ILogListener {
    ...
    private async init(currentUser: string): Promise<any> {
            ...
            if (entry.level == LogLevel.Error || LogLevel.Info) {
                if (!this._writeLogFailed) {
                    ...
                    let newLogItem: LogItem = new LogItem(this._applicationName,
                        ...
                        this._userId,
                        entry.message,
                        stackArray as string | undefined);
